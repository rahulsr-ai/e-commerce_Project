  ...
  return (
    isloading && (
      <div className="min-h-screen bg-neutral-950  ">
        <header className="bg-black border-b border-violet-800/20 px-6 py-6">
          <h1
            className="text-2xl font-bold text-black bg-gradient-to-r from-violet-600 to-violet-400 bg-clip-text
           text-transparent pl-10 text-center"
          >
            Customer Management
            {isSidebarOpen ? "sidebar is true" : "sidebar is false"}
          </h1>
        </header>

        <main className={` ${isSidebarOpen ? "" : "pl-16"}`}>
              ...
              <main className="p-6">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-400 mt-2">
                    Manage and track all customer Status
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                  {orderStats.map((stat, index) => (
                    <div
                      key={index}
                      className="shadow-md border-violet-500 border-2 hover:scale-95 transition-all duration-200
            ease-linear rounded-lg p-6"
                    >
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-6">
                  ...
                  <div className="flex gap-4">
                    <button className="flex items-center gap-2 px-4 py-2 hover:bg-white hover:text-black text-white rounded-lg
                    bg-purple-600">
                    ...
                    <select
                      ...
                      className="px-4 py-2  text-white bg-purple-700 rounded-lg  focus:ring-2 focus:ring-indigo-600 focus:outline-none
                  ...
                  <table className="w-full">
                    ...
                    <tbody className="divide-y divide-gray-800">
                      {paginatedOrders.map((order, index) => (
                        <tr
                          key={index}
                          className="bg-neutral-950 hover:bg-gray-800"
                        >
