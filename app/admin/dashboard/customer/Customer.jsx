            ...
            <main className="p-4 md:p-6">
              ...
              <div className="flex flex-col md:flex-row gap-4 mb-6">
                <div className="flex-1">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 bg-white text-black rounded-lg focus:ring-2 focus:ring-violet-600 focus:outline-none"
                    />
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <select
                    ...
                    className="px-4 py-2 text-white bg-violet-700 rounded-lg focus:ring-2 focus:ring-violet-600 focus:outline-none hover:bg-white hover:text-black"
                  >
              ...
              {isDetailsModalOpen && selectedOrder && (
                <div className=" fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center p-4">
                  <div className="bg-neutral-900 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto scrollbar-hide">
                      ...
                      <div className="space-y-6">
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              <div className="flex gap-2">
                                <button
                                  ...
                                  className="p-2 bg-violet-600 rounded-lg hover:bg-violet-700"
                                  title="Send Email"
                                >
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            className="w-full px-3 py-2 bg-gray-800 text-white rounded-lg focus:ring-2 focus:ring-violet-600 focus:outline-none"
                            rows={3}
