...
function Manageorder() {
  ...
  return (
    isloading && (
      <div className="min-h-screen bg-[#020301]  ">
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-6">
                  <div className="flex-1">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2 bg-gray-900 text-white rounded-lg focus:ring-2 focus:ring-indigo-600 focus:outline-none"
                      />
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <select
                      ...
                      className="px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 focus:ring-2 focus:ring-indigo-600 focus:outline-none"
                    >
