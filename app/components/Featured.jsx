...
const Featured = () => {
  ...
  return (
    <section className="py-16 dark:bg-gradient-to-b dark:from-black dark:to-purple-900/20">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold dark:text-[var(--primary-text-color)] mb-4">
            Featured Products
          </h2>
              ...
              >
                <div className="w-full h-64 relative">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    ...
                    <button className="px-3 py-1.5 rounded-md bg-[var(--primary-color)] hover:bg-violet-800 shadow-md text-white ">
                      Explore
                    </button>
                  </div>
                </div>
