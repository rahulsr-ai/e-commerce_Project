  ...
  return (
    ...
    <nav
      className={`fixed w-full z-50 top-0 left-0 transition-all duration-300 ${!isScrolled
        ...
        } ${!user?.role === "admin" ? "hidden" : ""}  ${role == "2637" ? "hidden" : ""
        }`}
    >
          ...
          <div className="hidden lg:flex items-center space-x-8 flex-1 justify-center">
            <Link
              ...
              className={` hover:text-white transition-all duration-200 flex items-center space-x-3 group
                 ${activelink === "home" ? "active-link" : "text-white/90"} `}
            >
              {/* <Home
                size={18}
            ...
            <Link
              ...
              href="/deals"
              className={` hover:text-white transition-all duration-200 flex items-center space-x-3 group
              ${activelink === "deals" ? "active-link" : "text-white/90"}  `}
            >
            ...
            <div className="relative group">
              <button
                ...
                ${activelink === "category" ? "active-link" : "text-white/90"}  `}
              >
        ...
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <div className="px-3 py-2">
            ...
            >
              ...
              <ChevronDown
                size={16}
                className={`transform transition-transform duration-200 ${categoryOpen ? "rotate-180" : ""
                  }`}
              />
            </button>
            <div
              className={`mt-2 space-y-1 transition-all duration-200 ${categoryOpen ? "opacity-100 h-fit" : "opacity-0 h-0"
                }`}
            >
          ...
          <div className="px-3 py-2">
            ...
            >
              ...
              <ChevronDown
                size={16}
                className={`transform transition-transform duration-200 ${brandsOpen ? "rotate-180" : ""
                  }`}
              />
            </button>
            <div
              className={`mt-2 space-y-1 transition-all duration-200 ${brandsOpen ? "opacity-100" : "opacity-0"
                }`}
            >
              {brands.map((brand) => (
                <Link
