...
const product = {
  ...
  price: 299.99,
  description:
    "Experience crystal-clear sound with our premium wireless headphones. Featuring active noise cancellation, 40-hour battery life, and premium materials for ultimate comfort.",
  rating: 4.8,
  reviews: 128,
...
const reviews = [
  {
    ...
    date: "2 weeks ago",
    comment:
      "These headphones are absolutely amazing! The sound quality is crystal clear, and the noise cancellation works perfectly. Battery life is impressive too.",
    avatar:
  ...
  },
  {
    ...
    date: "1 month ago",
    comment:
      "Great headphones overall. The comfort is outstanding for long listening sessions. Only minor issue is the ProductPageNew could be more intuitive.",
    avatar:
  ...
  },
  {
    ...
    date: "2 months ago",
    comment:
      "The sound quality exceeded my expectations. These are now my go-to headphones for both work and travel. Worth every penny!",
    avatar:
...
const faqs = [
  {
    ...
    answer:
      "The package includes the wireless headphones, a carrying case, USB-C charging cable, 3.5mm audio cable, and user manual.",
  },
  {
    question: "How long does the battery last?",
    answer:
      "The battery lasts up to 40 hours with active noise cancellation enabled, and up to 60 hours with ANC turned off.",
  },
  {
    question: "Is there a mobile ProductPageNew available?",
    answer:
      "Yes, our mobile ProductPageNew is available for both iOS and Android devices. It allows you to customize EQ settings, update firmware, and control noise cancellation levels.",
  },
  {
    question: "What's the warranty coverage?",
    answer:
      "We offer a 2-year warranty that covers manufacturing defects and hardware issues. This doesn't cover water damage or physical damage from drops.",
  },
];
  ...
  return (
    <div
      className={`min-h-screen ${
        darkMode
          ? "bg-violet-text-violet-400 text-gray-100"
          : "bg-black text-white"
      }`}
    >
      {/* Navigation */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div>
              ...
              <div className="mt-2 flex items-center space-x-3">
                <button
                  ...
                  className="px-4 py-2 border rounded-md hover:bg-violet-800 transition-colors"
                >
                  -
                </button>
            ...
            <div className="flex gap-4">
              <button className="flex-1 bg-violet-700 text-white py-4 px-6 rounded-lg hover:bg-violet-700 transition-colors flex items-center justify-center space-x-2">
            ...
            <div className="grid grid-cols-2 gap-4 pt-6 border-t">
              <div className="flex items-center space-x-3 bg-zinc-950 shadow-md p-4 rounded-lg">
                <Truck className="w-6 h-6 text-violet-500 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-center space-x-3 bg-zinc-950 shadow-md p-4 rounded-lg">
                <RefreshCw className="w-6 h-6 text-violet-500 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-center space-x-3 bg-zinc-950 shadow-md p-4 rounded-lg">
                <Package className="w-6 h-6 text-violet-500 flex-shrink-0" />
                <div>
        ...
        {/* <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {product.specs.map((spec, index) => (
              <div
                key={index}
                className="bg-neutral-950 p-4 rounded-lg shadow-sm"
              >
                <h3 className="text-sm font-medium text-white">{spec.name}</h3>
                <p className="mt-1 text-lg font-medium text-violet-400">
                  {spec.value}
                </p>
              </div>
            ))}
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {product.relatedProducts.map((item) => (
              <div
                key={item.id}
                className="bg-neutral-900 aspect-[2/2] rounded-lg shadow-sm overflow-hidden"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className={`text-lg ${darkMode ? "text-gray-400" : "text-white"}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reviews.map((review) => (
            <div
              key={review.id}
              className={`${
                darkMode ? "bg-gray-800" : "bg-neutral-950"
            ...
            >
              ...
              <p
                className={`${
                  darkMode ? "text-gray-300" : "text-violet-300"
                } leading-relaxed`}
              >
                {review.comment}
              </p>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className={`${
                  darkMode ? "bg-gray-700" : "bg-neutral-950"
      ...
      <div
        className={`${
          darkMode ? "bg-violet-text-violet-400" : "bg-black"
        } py-16`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-xl mx-auto text-center">
            ...
            <form onSubmit={handleSubscribe} className="flex gap-4">
              ...
              <button
                type="submit"
                className="px-6 py-3 bg-violet-700 text-white rounded-lg hover:bg-violet-900 transition-colors flex items-center space-x-2"
              >
      ...
      <footer
        className={`${
          darkMode ? "bg-black border-violet-600" : "bg-black border-violet-200"
        } border-t`}
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              ...
              <p className={`${darkMode ? "text-white" : "text-white"}`}>
                We're dedicated to providing the best audio experience with
                cutting-edge technology and premium quality products.
              </p>
            </div>
            <div>
              <h3
